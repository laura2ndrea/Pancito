...
CREATE TABLE IF NOT EXISTS Ingredientes_Presentaciones (
	id INT PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS Compras (
	cantidad INT NOT NULL, 
    id_orden INT, 
    id_ingrediente_presentacion INT, 
    PRIMARY KEY (id_orden, id_ingrediente_presentacion),
    FOREIGN KEY (id_orden) REFERENCES Ordenes(id),
    FOREIGN KEY (id_ingrediente_presentacion) REFERENCES Ingredientes_Presentaciones(id)
);
